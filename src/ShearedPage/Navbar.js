...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <li><Link to="/"
              className="text-gray-300 hover:text-white font-semibold tracking-tight">Home</Link></li>
            {user?.role === "admin" && (
    ...
    <a className="btn btn-ghost normal-case text-xl text-gray-300 hover:text-white font-semibold tracking-tight">Demo</a>
  </div>
  <div className="navbar-end px-2 hidden lg:flex">
    <ul className="menu menu-horizontal ">
      <li><Link to="/"
              className="text-gray-400 hover:text-white font-semibold tracking-tight">Home</Link></li>
            {user?.role === "admin" && (
            <li className="block mt-4 md:inline-block md:mt-0 lg:inline-block lg:mt-0">
              <Link
                to="/adminpannel"
